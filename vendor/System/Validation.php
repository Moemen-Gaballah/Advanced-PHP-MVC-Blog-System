...
class Validation
{
	...
	*/
	...
	/**
	* Determine if the given input has fload value
	*
	* @param string $inputName
	* @param string $customErrorMessage
	* @return $this
	*/
	public function float($inputName, $customErrorMessage = null)
	{
		...
		if(! is_float($inputValue)) {
			$message = $customErrorMessage ?: sprintf('%s should be a float number', ucfirst($inputName));
			$this->addError($inputName, $message);
		}
		return $this;
	}
	...
	/**
	* Determine if the given value should  be at least the given length
	*
	* @param string $inputName
	* @param int $length
	* @param string $customErrorMessage
	* @return $this
	*/
	public function minLen($inputName, $length = 6, $customErrorMessage = null)
	{
		if($this->hasErrors($inputName)){
			return $this;
		}
	...
	/**
	* Determine if the given value should  be at max the given length
	*
	* @param string $inputName
	* @param int $length
	* @param string $customErrorMessage
	...
	*/
	public function maxLen($inputName, $customErrorMessage = null)
	{
		...
		if(strlen($inputValue) > $length) {
			$message = $customErrorMessage ?: sprintf('%s should be max %d', ucfirst($inputName), $length);
			$this->addError($inputName, $message);
		}
		return $this;
	}
	...
	*/
	...
	/**
	* Get the value fr the given input name
	*
	* @param string $input
	* @return mixed
	*/
